---
name: gamet-discovery
description: "Proactively identifies what to build next — analyzes persona frustrations, learning log patterns, regulatory needs, competitive gaps, and adoption chain. Triggers on 'what should we build?', 'what gives most value?', 'roadmap', 'feature ideas'."
---
...
5. **Adoption chain analysis** → chain break prevention
